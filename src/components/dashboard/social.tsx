    ...
    return (
      <div
        ...
        className={`p-6 rounded-xl shadow flex items-center justify-center cursor-pointer ${
          isLast ? 'bg-blue-100' : item.color // 마지막 아이템이면 고정 색상, 아니면 아이템 색상
        }`}
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-80">
              ...
              <button
                onClick={closeModal} // 닫기 버튼 클릭 시 closeModal 호출
                className="mt-4 bg-blue-500 text-white py-2 px-4 rounded">
                닫기
              </button>
              <button
                onClick={handleAddItem} // 추가 버튼 클릭 시 handleAddItem 호출
        ...
        {isEditModalOpen && (
          <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-80">
              ...
              <button
                onClick={closeEditModal} // 닫기 버튼 클릭 시 closeEditModal 호출
                className="mt-4 bg-blue-500 text-white py-2 px-4 rounded">
                닫기
              </button>
              <button
                onClick={handleDeleteItem} // 삭제 버튼 클릭 시 handleDeleteItem 호출
