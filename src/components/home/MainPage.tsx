...
const Frame: NextPage = () => {
  ...
  return (
    <div className="w-[1920px] h-[5258px] relative bg-white">
      <div className="w-[1920px] h-[1080px] left-0 top-0 absolute inline-flex flex-col justify-start items-start gap-0.5">
        ...
        <div className="self-stretch h-[925px] relative overflow-hidden">
          <div className="w-[1920px] h-[925px] left-0 top-0 absolute bg-gradient-to-b from-sky-300 to-neutral-200 rounded-[40px]"></div>
