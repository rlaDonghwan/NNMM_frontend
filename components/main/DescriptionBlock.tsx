...
export default function DescriptionBlock() {
  return (
    <div className="w-full px-4 py-12 bg-white">
      ...
      {/* 하단 텍스트 */}
      <div className="max-w-6xl mx-auto mt-16 text-center text-black text-3xl sm:text-4xl lg:text-5xl font-normal font-apple leading-snug md:leading-[1.3] lg:leading-[1.25] [text-shadow:_0px_4px_4px_rgb(0_0_0_/_0.25)]">
